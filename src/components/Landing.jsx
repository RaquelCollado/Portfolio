...
function Landing() {
  return (
    <div className='landing'>
        <section className='landing_bio'>
            <h2 className='landing_bio_title'>Sobre mí</h2>
            <img className='landing_bio_photo' src="" alt="" />
            <p className='landing_bio_desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt nihil ut quas! Quasi fugit consectetur assumenda ea voluptatem? Velit quod vitae sapiente aliquid officiis nostrum. Illo itaque quidem nostrum voluptates?</p>
        </section>

        <section className='landing_project'>
